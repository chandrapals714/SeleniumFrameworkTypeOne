...
{
    public class CommitteeConstituent : Committee
    {
        ...
        //kw
        public CommitteeConstituent(string committee, Address address, string Prefix = "", string MailStop = "", string AddressType = "Work",
